...
public class DownloadDialog extends JFrame {
    ...
    private class DownloadRequestHandler extends AbstractRequestHandler {
         ...
         * (non-Javadoc)
         * @see
         * org.lobobrowser.request.AbstractRequestHandler#handleException(org.lobobrowser
         ...
         * (non-Javadoc)
         * @see
         * org.lobobrowser.request.AbstractRequestHandler#handleProgress(org.lobobrowser
         * .ua.ProgressType, java.net.URL, java.lang.String, int, int)
         */
        @Override
         ...
         * (non-Javadoc)
         * @see
         * org.lobobrowser.request.AbstractRequestHandler#processResponse(org.lobobrowser
