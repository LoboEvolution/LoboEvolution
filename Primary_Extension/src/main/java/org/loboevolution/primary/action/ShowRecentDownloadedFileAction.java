 ...
 */
public class ShowRecentDownloadedFileAction extends ActionPool {
	 ...
	 *            the window
	 */
	public ShowRecentDownloadedFileAction(ComponentSource componentSource, NavigatorWindow window) {
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (!(awtWindow instanceof Frame)) {
			throw new IllegalStateException("Downloaded Files dialog only supported when an AWT Frame is available.");
		}

		FilesDialog dialog = new FilesDialog("SAVE");
