...
public class ComponentSource implements NavigatorWindowListener {
    ...
    public JMenu getFileMenu() {
        ...
        menu.setMnemonic('F');
        menu.add(menuItem("Save As", 'S', "ctrl S", new SaveFileAction(this,
                window)));
        menu.addSeparator();
        menu.add(menuItem("Blank Window", 'B', KeyStroke.getKeyStroke(
                KeyEvent.VK_B, InputEvent.CTRL_MASK | InputEvent.SHIFT_MASK),
                new BlankWindowAction(this, window)));
        menu.addSeparator();
        menu.add(menuItem("Cloned Window", 'C', new ClonedWindowAction(this,
                window, actionPool)));
        menu.addSeparator();
        menu.add(menuItem("File...", 'F', "ctrl O", new OpenFileAction(this,
                window)));
        menu.addSeparator();
    ...
    public JMenu getBookmarksMenu() {
        ...
        menu.add(menuItem("Search Bookmarks", 'S', new SearchBookmarksAction(
                this, window)));
        menu.add(menuItem("Show All Bookmarks", 'S', new ShowBookmarksAction(
                this, window)));
        return menu;
    }
    ...
    public JMenu getNavigationMenu() {
        ...
        menu.add(menuItem("Forward", 'F', new ForwardAction(this, window,
                actionPool)));
        menu.add(menuItem("Stop", 'S', KeyStroke.getKeyStroke(
                KeyEvent.VK_ESCAPE, 0), new StopAction(this, window)));
        menu.add(menuItem("Reload", 'R', KeyStroke.getKeyStroke(KeyEvent.VK_F5,
                0), new ReloadAction(this, window, actionPool)));
        menu.addSeparator();
    ...
    public JMenu getToolsMenu() {
        ...
        menu.add(menuItem("Preferences...", 'P', new PreferencesAction(this,
                window)));
        menu.add(menuItem("Clear Cache", 'M', "ctrl M", new ClearCacheAction(
                this, window)));
        return menu;
    }
     ...
     * (non-Javadoc)
     * @see
     * org.lobobrowser.ua.NavigatorWindowListener#defaultStatusUpdated(org.lobobrowser
     ...
     * (non-Javadoc)
     * @see
     * org.lobobrowser.ua.NavigatorWindowListener#documentAccessed(org.lobobrowser
     * .ua.NavigatorWindowEvent)
     */
    @Override
     ...
     * (non-Javadoc)
     * @see
     * org.lobobrowser.ua.NavigatorWindowListener#documentRendering(org.lobobrowser
     * .ua.NavigatorWindowEvent)
     */
    @Override
     ...
     * (non-Javadoc)
     * @see
     * org.lobobrowser.ua.NavigatorWindowListener#progressUpdated(org.lobobrowser
     * .ua.NavigatorProgressEvent)
     */
    @Override
