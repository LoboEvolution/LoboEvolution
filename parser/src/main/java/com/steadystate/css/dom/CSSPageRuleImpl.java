...
public class CSSPageRuleImpl extends AbstractCSSRuleImpl implements CSSPageRule {
	...
	public void setCssText(final String cssText) throws DOMException {
		...
		try {
			...
			if (r.getType() == CSSRule.PAGE_RULE) {
				...
				throw new DOMExceptionImpl(DOMException.INVALID_MODIFICATION_ERR, DOMExceptionImpl.EXPECTING_PAGE_RULE);
			}
	...
	public boolean equals(final Object obj) {
		...
		return super.equals(obj) && LangUtils.equals(getSelectorText(), cpr.getSelectorText())
