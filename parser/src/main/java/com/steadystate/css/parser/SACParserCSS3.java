...
public class SACParserCSS3 extends AbstractSACParser implements Parser,
	...
	final public void importRule(final boolean nonImportRuleFoundBefore)
		...
		try {
			...
			if (nonImportRuleFoundBefore) {
				getErrorHandler().error(
						toCSSParseException("invalidImportRuleIgnored2", e));
			} else {
		...
		try {
			...
			case 4:
				c = ((com.steadystate.css.parser.selectors.ConditionFactoryImpl) getConditionFactory())
						.createPrefixAttributeCondition(name, null,
								null != value, value);
				break;
			case 5:
				c = ((com.steadystate.css.parser.selectors.ConditionFactoryImpl) getConditionFactory())
						.createSuffixAttributeCondition(name, null,
								null != value, value);
				break;
			case 6:
				c = ((com.steadystate.css.parser.selectors.ConditionFactoryImpl) getConditionFactory())
						.createSubstringAttributeCondition(name, null,
								null != value, value);
				break;
			}
			if (c instanceof Locatable) {
	...
	final public LexicalUnit term(LexicalUnit prev) throws ParseException {
		...
		case IDENT:
			...
			case COLON:
				...
				{
					if (true)
						throw toCSSParseException("invalidExprColon",
								new String[] { t.image }, getLocator());
				}
				break;
			default:
				jj_la1[93] = jj_gen;
	...
	final public Selector negation_arg() throws ParseException {
		...
		case COLON:
			...
			if (o instanceof Condition) {
				...
				pseudoElementSel = (SimpleSelector) o;
				negationArg = getSelectorFactory().createDescendantSelector(
						null, pseudoElementSel);
			}
			break;
		default:
			jj_la1[102] = jj_gen;
		...
		simpleSel = getSelectorFactory()
				.createConditionalSelector(simpleSel, c);
		{
			if (true)
				return simpleSel;
		}
	...
	private static void jj_la1_init_0() {
		jj_la1_0 = new int[] { 0x2, 0x2, 0x2, 0x2, 0x0, 0x80000, 0x80000,
				0x80000, 0x2, 0x2, 0x2, 0x80000, 0x2, 0x2, 0x400000, 0x2,
				0x80000, 0x2, 0x2, 0x80000, 0x0, 0x2, 0x80000, 0x2, 0x80000,
				0x80000, 0x2, 0x2, 0x2, 0x0, 0x2, 0x80000, 0x0, 0x2, 0x80000,
				0x2, 0x2, 0x80000, 0x0, 0x2, 0x80000, 0x2, 0x2, 0x0, 0x2, 0x2,
				0x2, 0x0, 0x2, 0x0, 0x2, 0x0, 0x2, 0x2, 0x1, 0x2, 0x0, 0x2,
				0x2, 0x0, 0x0, 0x0, 0x0, 0x80000, 0x80000, 0x2, 0x2, 0x0, 0x2,
				0x480000, 0x2, 0x0, 0x0, 0x2, 0x2, 0x2, 0x2, 0x2, 0x4a0000,
				0x2, 0x4a0000, 0x80000, 0x80000, 0x0, 0x2, 0x80000, 0x2, 0x0,
				0x2, 0x4e0000, 0x0, 0x0, 0x20000, 0x0, 0x4e0000, 0x2, 0x2,
				0x4e0000, 0x0, 0x2, 0x0, 0x4e0000, 0x80000, };
	}

	private static void jj_la1_init_1() {
		jj_la1_1 = new int[] { 0x3000, 0x3000, 0x3000, 0x3000, 0x20000000,
				0x1f000000, 0x1d000000, 0x1f000000, 0x3000, 0x3000, 0x0,
				0x3f000000, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x7000000,
				0x800000, 0x0, 0x7000000, 0x0, 0x7000000, 0x5000000, 0x0, 0x0,
				0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0,
				0x0, 0x0, 0x0, 0x800000, 0x0, 0x0, 0x0, 0x700000, 0x0,
				0x700000, 0x700000, 0x100000, 0x0, 0x0, 0x0, 0x0, 0x800000,
				0x0, 0x0, 0x1000000, 0x1000000, 0x1000000, 0x1000000,
				0x1000000, 0x0, 0x0, 0x0, 0x7c000, 0x0, 0x0, 0x0, 0x7c000, 0x0,
				0x0, 0x0, 0x0, 0x0, 0x0, 0x100000, 0x0, 0x100000, 0x0, 0x0,
				0x0, 0x0, 0x0, 0x0, 0x40000000, 0x0, 0x81900000, 0x800000,
				0x100000, 0x80000000, 0x0, 0x81000000, 0x0, 0x0, 0x81900000,
				0x800000, 0x0, 0x800000, 0x81100000, 0x1000000, };
	}

	private static void jj_la1_init_2() {
		jj_la1_2 = new int[] { 0x0, 0x0, 0x0, 0x0, 0x0, 0x91a00000, 0x91a00000,
				0x91a00000, 0x0, 0x0, 0x0, 0x91a00000, 0x0, 0x0, 0x10000, 0x0,
				0x0, 0x0, 0x0, 0x91a00000, 0x0, 0x0, 0x91a00000, 0x0,
				0x91a00000, 0x91a00000, 0x0, 0x0, 0x0, 0x800000, 0x0, 0x0,
				0x400000, 0x0, 0x0, 0x0, 0x0, 0x0, 0x400000, 0x0, 0x0, 0x0,
				0x0, 0x2000000, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x4000000,
				0x0, 0x0, 0x100000, 0x0, 0x0, 0x0, 0x0, 0x10a00000, 0x10a00000,
				0x10a00000, 0x10a00000, 0x11a00000, 0x1000000, 0x0, 0x0,
				0x8000000, 0x0, 0x0, 0x0, 0x8000000, 0x800000, 0x0, 0x0, 0x0,
				0x0, 0x0, 0x4008000, 0x0, 0x4008000, 0xe0000, 0x0, 0x400000,
				0x0, 0x0, 0x0, 0x0, 0x0, 0x609ffff, 0x2000000, 0x4000000,
				0x87fff, 0x800000, 0x9ffff, 0x0, 0x0, 0xc09ffff, 0x8000000,
				0x0, 0x8000000, 0x409ffff, 0x11a00000, };
	}
