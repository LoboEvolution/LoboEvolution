 ...
 * @author rbri
 */
@SuppressWarnings("all") public class SACParserCSSmobileOKBasic1 extends AbstractSACParser implements SACParserCSSmobileOKBasic1Constants {
...
Condition c = this.getConditionFactory().createClassCondition(null, t.image);
            ...
            return (pred == null) ? c : this.getConditionFactory().createAndCondition(pred, c);    } catch (ParseException e) {
...
//  ;
//
  final public SimpleSelector pseudoElement() throws ParseException {SimpleSelector sel;
    Token t;
    try {
      switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
      case FIRST_LETTER:{
