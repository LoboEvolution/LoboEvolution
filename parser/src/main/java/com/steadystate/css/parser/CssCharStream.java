...
/**
 * An implementation of interface CharStream. There is no processing of escaping
 * in this class because the escaping is part of the parser. CSS has some
 * strange rules about that, so processing unicode escapes in this class is too
 * early.
 */
