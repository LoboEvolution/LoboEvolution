...
public final class ParserUtils {
	 ...
	 *            the StringBuilder
	 * @param left
	 *            no of chars to be removed from start
	 * @param right
	 *            no of chars to be removed from end
	...
	/**
	 * Helper that removes the leading "url(", the trailing ")" and surrounding
	 * quotes from the given string builder.
	 * 
	 * @param s
	 *            the StringBuilder
	 * @return
