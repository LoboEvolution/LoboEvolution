...
/**
 * This class is the abstract parent for all views of the array. It shows a view
 * of the underlying NativeArrayBuffer. Many views may simultaneously share the
 * same buffer, and changes to one will affect all.
 */
...
public abstract class NativeArrayBufferView extends IdScriptableObject {
	...
	/**
	 * Return the offset in bytes from the start of the buffer that this view
	 * represents.
	 */
	...
	/**
	 * Return the length, in bytes, of the part of the buffer that this view
	 * represents.
	 */
	...
	private static final int Id_buffer = 1, Id_byteOffset = 2, Id_byteLength = 3, MAX_INSTANCE_ID = Id_byteLength;
