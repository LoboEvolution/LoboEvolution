...
public class NativeDataView extends NativeArrayBufferView {
	...
	private Object js_getInt(int bytes, boolean signed, Object[] args) {
		...
		switch (bytes) {
		case 1:
			return signed ? ByteIo.readInt8(arrayBuffer.buffer, offset) : ByteIo.readUint8(arrayBuffer.buffer, offset);
		case 2:
	...
	private static final int Id_constructor = 1, Id_getInt8 = 2, Id_getUint8 = 3, Id_getInt16 = 4, Id_getUint16 = 5,
			Id_getInt32 = 6, Id_getUint32 = 7, Id_getFloat32 = 8, Id_getFloat64 = 9, Id_setInt8 = 10, Id_setUint8 = 11,
			Id_setInt16 = 12, Id_setUint16 = 13, Id_setInt32 = 14, Id_setUint32 = 15, Id_setFloat32 = 16,
			Id_setFloat64 = 17, MAX_PROTOTYPE_ID = Id_setFloat64;
