...
public final class JavaAdapter implements IdFunctionCall {
	...
	static Object js_createAdapter(Context cx, Scriptable scope, Object[] args) {
		...
		for (classCount = 0; classCount < N - 1; classCount++) {
			...
			if (!(arg instanceof NativeJavaClass)) {
				throw ScriptRuntime.typeError2("msg.not.java.class.arg", String.valueOf(classCount),
	...
	private static void generateCtor(ClassFileWriter cfw, String adapterName, String superName,
		...
		if (parameters.length == 0) {
			cfw.startMethod("<init>",
					"(Lorg/mozilla/javascript/Scriptable;" + "Lorg/mozilla/javascript/ContextFactory;)V",
			...
			StringBuilder sig = new StringBuilder(
					"(Lorg/mozilla/javascript/Scriptable;" + "Lorg/mozilla/javascript/ContextFactory;");
	...
	static void generateReturnResult(ClassFileWriter cfw, Class<?> retType, boolean callConvertResult) {
		...
		if (retType == Void.TYPE) {
			...
			cfw.addInvoke(ByteCode.INVOKESTATIC, "org/mozilla/javascript/Context", "toBoolean",
					"(Ljava/lang/Object;)Z");
