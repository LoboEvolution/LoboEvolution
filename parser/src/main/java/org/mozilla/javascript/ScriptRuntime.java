...
public class ScriptRuntime {
	...
	public static ScriptableObject initSafeStandardObjects(Context cx, ScriptableObject scope, boolean sealed) {
		...
		if (cx.getLanguageVersion() >= Context.VERSION_1_8 && cx.hasFeature(Context.FEATURE_V8_EXTENSIONS)
				|| cx.getLanguageVersion() >= Context.VERSION_ES6) {
			new LazilyLoadedCtor(scope, "ArrayBuffer", "org.mozilla.javascript.typedarrays.NativeArrayBuffer", sealed,
					true);
			new LazilyLoadedCtor(scope, "Int8Array", "org.mozilla.javascript.typedarrays.NativeInt8Array", sealed,
					true);
			new LazilyLoadedCtor(scope, "Uint8Array", "org.mozilla.javascript.typedarrays.NativeUint8Array", sealed,
					true);
			new LazilyLoadedCtor(scope, "Uint8ClampedArray",
					"org.mozilla.javascript.typedarrays.NativeUint8ClampedArray", sealed, true);
			new LazilyLoadedCtor(scope, "Int16Array", "org.mozilla.javascript.typedarrays.NativeInt16Array", sealed,
					true);
			new LazilyLoadedCtor(scope, "Uint16Array", "org.mozilla.javascript.typedarrays.NativeUint16Array", sealed,
					true);
			new LazilyLoadedCtor(scope, "Int32Array", "org.mozilla.javascript.typedarrays.NativeInt32Array", sealed,
					true);
			new LazilyLoadedCtor(scope, "Uint32Array", "org.mozilla.javascript.typedarrays.NativeUint32Array", sealed,
					true);
			new LazilyLoadedCtor(scope, "Float32Array", "org.mozilla.javascript.typedarrays.NativeFloat32Array", sealed,
					true);
			new LazilyLoadedCtor(scope, "Float64Array", "org.mozilla.javascript.typedarrays.NativeFloat64Array", sealed,
					true);
			new LazilyLoadedCtor(scope, "DataView", "org.mozilla.javascript.typedarrays.NativeDataView", sealed, true);
		}

		if (cx.getLanguageVersion() >= Context.VERSION_ES6) {
			new LazilyLoadedCtor(scope, NativeSymbol.CLASS_NAME, NativeSymbol.class.getName(), sealed, true);
	 ...
	 *
	 * @deprecated Use {@link #toObjectOrNull(Context, Object, Scriptable)}
	 *             instead
	 */
	@Deprecated
	 ...
	 *
	 * @deprecated Use
	 *             {@link #getObjectElem(Object, Object, Context, Scriptable)}
	 *             instead
	 */
	@Deprecated
	 ...
	 *
	 * @deprecated Use
	 *             {@link #getObjectProp(Object, String, Context, Scriptable)}
	 *             instead
	 */
	@Deprecated
	...
	/**
	 * @deprecated Use
	 *             {@link #getObjectPropNoWarn(Object, String, Context, Scriptable)}
	 *             instead
	 */
	@Deprecated
	 ...
	 *
	 * @deprecated Use
	 *             {@link #getObjectIndex(Object, double, Context, Scriptable)}
	 *             instead
	 */
	@Deprecated
	 ...
	 *
	 * @deprecated Use
	 *             {@link #setObjectElem(Object, Object, Object, Context, Scriptable)}
	 *             instead
	 */
	@Deprecated
	 ...
	 *
	 * @deprecated Use
	 *             {@link #setObjectProp(Object, String, Object, Context, Scriptable)}
	 *             instead
	 */
	@Deprecated
	 ...
	 *
	 * @deprecated Use
	 *             {@link #setObjectIndex(Object, double, Object, Context, Scriptable)}
	 *             instead
	 */
	@Deprecated
	...
	/**
	 * @deprecated Use {@link #specialRef(Object, String, Context, Scriptable)}
	 *             instead
	 */
	@Deprecated
	...
	/**
	 * @deprecated Use
	 *             {@link #delete(Object, Object, Context, Scriptable, boolean)}
	 *             instead
	 */
	@Deprecated
	 ...
	 *
	 * @deprecated Use {@link #enumInit(Object, Context, Scriptable, int)}
	 *             instead
	 */
	@Deprecated
	 ...
	 *
	 * @deprecated Use
	 *             {@link #getElemFunctionAndThis(Object, Object, Context, Scriptable)}
	 *             instead
	 */
	@Deprecated
	 ...
	 *
	 * @deprecated Use
	 *             {@link #getPropFunctionAndThis(Object, String, Context, Scriptable)}
	 *             instead
	 */
	@Deprecated
	...
	public static Object applyOrCall(boolean isApply, Context cx, Scriptable scope, Scriptable thisObj, Object[] args) {
		...
		if (L != 0) {
			if (cx.hasFeature(Context.FEATURE_OLD_UNDEF_NULL_THIS)) {
				...
				callThis = args[0] == Undefined.instance ? Undefined.SCRIPTABLE_UNDEFINED
						: toObjectOrNull(cx, args[0], scope);
			}
		}
		if (callThis == null && cx.hasFeature(Context.FEATURE_OLD_UNDEF_NULL_THIS)) {
			callThis = getTopCallScope(cx); // This covers the case of args[0]
	 ...
	 *
	 * @deprecated Use {@link #nameIncrDecr(Scriptable, String, Context, int)}
	 *             instead
	 */
	@Deprecated
	...
	/**
	 * @deprecated Use
	 *             {@link #propIncrDecr(Object, String, Context, Scriptable, int)}
	 *             instead
	 */
	@Deprecated
	...
	/**
	 * @deprecated Use
	 *             {@link #elemIncrDecr(Object, Object, Context, Scriptable, int)}
	 *             instead
	 */
	@Deprecated
	...
	/**
	 * @deprecated Use {@link #refIncrDecr(Ref, Context, Scriptable, int)}
	 *             instead
	 */
	@Deprecated
	...
	public static boolean isPrimitive(Object obj) {
		return obj == null || obj == Undefined.instance || obj instanceof Number || obj instanceof String
	...
	/**
	 * @deprecated Use
	 *             {@link #doTopCall(Callable, Context, Scriptable, Scriptable, Object[], boolean)}
	 *             instead
	 */
	@Deprecated
	...
	/**
	 * @deprecated Use
	 *             {@link #createFunctionActivation(NativeFunction, Scriptable, Object[], boolean)}
	 *             instead
	 */
	@Deprecated
	...
	public static Scriptable createArrowFunctionActivation(NativeFunction funObj, Scriptable scope, Object[] args,
			boolean isStrict) {
	 ...
	 * the version called from new code. <strong>This method only present for
	 * compatibility.</strong>
	 * 
	 * @deprecated Use
	 *             {@link #newObjectLiteral(Object[], Object[], int[], Context, Scriptable)}
	 *             instead
	 */
	@Deprecated
	...
	/**
	 * Equivalent to executing "new Error(message, sourceFileName,
	 * sourceLineNo)" from JavaScript.
	 * 
	 * @param cx
	 *            the current context
	 * @param scope
	...
	public static JavaScriptException throwError(Context cx, Scriptable scope, String message) {
		int[] linep = { 0 };
		String filename = Context.getSourcePositionFromStack(linep);
		final Scriptable error = newBuiltinObject(cx, scope, TopLevel.Builtins.Error,
				new Object[] { message, filename, Integer.valueOf(linep[0]) });
		return new JavaScriptException(error, filename, linep[0]);
	}

	/**
	 * Equivalent to executing "new $constructorName(message, sourceFileName,
	 * sourceLineNo)" from JavaScript.
	 * 
	 * @param cx
	 *            the current context
