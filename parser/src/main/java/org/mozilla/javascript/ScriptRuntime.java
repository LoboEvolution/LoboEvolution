...
public class ScriptRuntime {
	...
	public static ScriptableObject initStandardObjects(Context cx,
		...
		if (withXml) {
			String xmlImpl = cx.getE4xImplementationFactory()
	...
	static String[] getTopPackageNames() {
		...
		return "Dalvik".equals(System.getProperty("java.vm.name")) ? new String[] {
	...
	public static int toInt32(double d) {
		...
		// (double)(long)!Double.isNaN(d) should hold here
	...
	private static boolean eqString(CharSequence x, Object y) {
		for (;;) {
			if (y == null || y == Undefined.instance) {
				...
				return toNumber(x.toString()) == (((Boolean) y).booleanValue() ? 1.0
						: 0.0);
			} else if (y instanceof Scriptable) {
				if (y instanceof ScriptableObject) {
					Object test = ((ScriptableObject) y).equivalentValues(x
	...
	public static Scriptable wrapException(Throwable t, Scriptable scope,
			Context cx) {
		RhinoException re;
		String errorName;
		String errorMsg;
		...
		for (int i = 0, end = propertyIds.length; i != end; ++i) {
			...
			if (id instanceof String) {
				if (getterSetter == 0) {
					...
					so.setGetterOrSetter((String) id, 0, getterOrSetter,
							isSetter);
				}
			} else {
	...
	public static RuntimeException undefCallError(Object object, Object id) {
		return typeError2("msg.undef.method.call", toString(object),
				toString(id));
	}

	public static RuntimeException undefWriteError(Object object, Object id,
			Object value) {
		return typeError3("msg.undef.prop.write", toString(object),
