...
final class NativeMath extends IdScriptableObject {
	...
	private static final int Id_toSource = 1, Id_abs = 2, Id_acos = 3, Id_asin = 4, Id_atan = 5, Id_atan2 = 6,
			...
			Id_random = 15, Id_round = 16, Id_sin = 17, Id_sqrt = 18, Id_tan = 19, Id_cbrt = 20, Id_cosh = 21,
			Id_expm1 = 22, Id_hypot = 23, Id_log1p = 24, Id_log10 = 25, Id_sinh = 26, Id_tanh = 27, Id_imul = 28,
			Id_trunc = 29,

			LAST_METHOD_ID = Id_trunc;

	/*
	 * Missing from ES6: acosh asinh atanh clz32 fround log2
	 */
