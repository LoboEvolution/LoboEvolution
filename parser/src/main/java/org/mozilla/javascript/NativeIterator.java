	...
	private static Object jsConstructor(Context cx, Scriptable scope, Scriptable thisObj, Object[] args) {
		...
		if (thisObj != null) {
			...
			if (iterator != null) {
				...
				return cx.getWrapFactory().wrap(cx, scope, new WrappedJavaIterator(iterator, scope),
		...
		Object objectIterator = ScriptRuntime.enumInit(obj, cx, scope,
				keyOnly ? ScriptRuntime.ENUMERATE_KEYS_NO_ITERATOR : ScriptRuntime.ENUMERATE_ARRAY_NO_ITERATOR);
