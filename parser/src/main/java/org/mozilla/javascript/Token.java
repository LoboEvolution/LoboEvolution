...
public class Token {
	...
	ERROR = -1, // well-known as the only code < EOF
			...
			ENUM_INIT_VALUES = 59, ENUM_INIT_ARRAY = 60, ENUM_INIT_VALUES_IN_ORDER = 61, ENUM_NEXT = 62, ENUM_ID = 63,
			THISFN = 64, RETURN_RESULT = 65, // to return previously stored
												// return result
			...
			ESCXMLATTR = 76, ESCXMLTEXT = 77, REF_MEMBER = 78, // Reference for
																// x.@y, x..y
																// etc.
	...
	public final static int FIRST_ASSIGN = ASSIGN, LAST_ASSIGN = ASSIGN_MOD,
			...
			LABEL = 131, // label
			TARGET = 132, LOOP = 133, EXPR_VOID = 134, // expression statement
														// in functions
			...
			CONST = 155, SETCONST = 156, SETCONSTVAR = 157, ARRAYCOMP = 158, // array
																				// comprehension
			LETEXPR = 159, WITHEXPR = 160, DEBUGGER = 161, COMMENT = 162, GENEXPR = 163, METHOD = 164, // ES6
																										// MethodDefinition
