...
public class Context {
	...
	/**
	 * Enables access to JavaScript features from ECMAscript 6 that are present
	 * in JavaScript engines that do not yet support version 6, such as V8. This
	 * includes support for typed arrays. Default is true.
	 * 
	 * @since 1.7 Release 3
	 */
	 ...
	 * Previously Rhino would convert an undefined "this" to null, whereas
	 * recent specs call for it to be treated differently. Default is to be set
	 * if language version <= 1.7.
	 * 
	 * @since 1.7.7
	 */
	...
	/**
	 * If set, then the order of property key enumeration will be first numeric
	 * keys in numeric order, followed by string keys in order of creation, and
	 * finally Symbol keys, as specified in ES6. Default is true for language
	 * version >= "ES6" and false otherwise.
	 * 
	 * @since 1.7.8
	 */
	...
	public void setLanguageVersion(int version) {
		...
		if (listeners != null && version != this.version) {
			firePropertyChangeImpl(listeners, languageVersionProperty, Integer.valueOf(this.version),
	...
	public final String getImplementationVersion() {
		if (implementationVersion == null) {
			...
			// There will be many manifests in the world -- enumerate all of
			...
			while (urls.hasMoreElements()) {
				...
				try {
					...
					if ("Mozilla Rhino".equals(attrs.getValue("Implementation-Title"))) {
						implementationVersion = "Rhino " + attrs.getValue("Implementation-Version") + " "
	...
	/**
	 * Initialize the standard objects, leaving out those that offer access
	 * directly to Java classes. This sets up "scope" to have access to all the
	 * standard JavaScript classes, but does not create global objects for any
	 * top-level Java packages. In addition, the "Packages," "JavaAdapter," and
	 * "JavaImporter" classes, and the "getClass" function, are not initialized.
	 *
	 * The result of this function is a scope that may be safely used in a
	 * "sandbox" environment where it is not desirable to give access to Java
	...
	public Object resumeContinuation(Object continuation, Scriptable scope, Object functionResult)
		...
		return Interpreter.restartContinuation((org.mozilla.javascript.NativeContinuation) continuation, this, scope,
				args);
	}
	 ...
	 * {@link WrappedException}, a subclass of {@link EvaluatorException}. The
	 * resulting exception object always contains source name and line number of
	 * script that triggered exception.
	 * <p>
