...
public abstract class ES6Iterator extends IdScriptableObject {
	...
	ES6Iterator(Scriptable scope) {
		...
		IdScriptableObject prototype = (IdScriptableObject) ScriptableObject.getTopScopeValue(top, getTag());
	...
	private static final int Id_next = 1, Id_iterator = 2, Id_toStringTag = 3, MAX_PROTOTYPE_ID = Id_toStringTag;
