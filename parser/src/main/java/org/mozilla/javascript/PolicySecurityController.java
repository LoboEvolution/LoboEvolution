...
public class PolicySecurityController extends SecurityController {
	...
	public GeneratedClassLoader createClassLoader(final ClassLoader parent, final Object securityDomain) {
		return (Loader) AccessController
				.doPrivileged((PrivilegedAction<Object>) () -> new Loader(parent, (CodeSource) securityDomain));
	}
	...
	public Object callWithDomain(final Object securityDomain, final Context cx, Callable callable, Scriptable scope,
		...
		final ClassLoader classLoader = (ClassLoader) AccessController
				.doPrivileged((PrivilegedAction<Object>) () -> cx.getApplicationClassLoader());
			...
			if (caller == null) {
				try {
					...
					caller = (SecureCaller) AccessController.doPrivileged((PrivilegedExceptionAction<Object>) () -> {
						...
						Class<?> c = loader.defineClass(SecureCaller.class.getName() + "Impl",
