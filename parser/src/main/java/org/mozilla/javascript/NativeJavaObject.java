	...
	static Object coerceTypeImpl(Class<?> type, Object value) {
		...
		case JSTYPE_OBJECT:
			if (type == ScriptRuntime.StringClass) {
				...
				// Try to use function/object as implementation of Java
				// interface.
	...
	private static Object coerceToNumber(Class<?> type, Object value) {
		...
		if (type == ScriptRuntime.IntegerClass || type == Integer.TYPE) {
			if (valueClass == ScriptRuntime.IntegerClass) {
				...
				return Integer.valueOf(
						(int) toInteger(value, ScriptRuntime.IntegerClass, Integer.MIN_VALUE, Integer.MAX_VALUE));
			}
		}
		...
		if (type == ScriptRuntime.ShortClass || type == Short.TYPE) {
			if (valueClass == ScriptRuntime.ShortClass) {
				...
				return Short
						.valueOf((short) toInteger(value, ScriptRuntime.ShortClass, Short.MIN_VALUE, Short.MAX_VALUE));
			}
		}
