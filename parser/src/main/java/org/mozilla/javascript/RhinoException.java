...
public abstract class RhinoException extends RuntimeException {
	 ...
	 * optimization is enabled, this includes java stack elements whose source
	 * and method names suggest they have been generated by the Rhino script
	 * compiler. The optional "limit" parameter limits the number of stack
	 * frames returned. The "functionName" parameter will exclude any stack
	 * frames "below" the specified function on the stack.
	 *
	 * @param limit
	 *            the number of stack frames returned
	 * @param functionName
	 *            the name of a function on the stack -- frames below it will be
	 *            ignored
	 * @return a script stack dump
	 * @since 1.8.0
	 */
	 ...
	 *
	 * @param limit
	 *            the number of stack frames returned, or -1 for unlimited
	 * @param hideFunction
	 *            the name of a function on the stack -- frames below it will be
	 *            ignored, or null
	 * @return the script stack for this exception
	 ...
	 * (<code>functionName()@fileName:lineNumber</code>) instead of Rhino's own
	 * Java-inspired format
	 * (<code>    at fileName:lineNumber (functionName)</code>). Use
	 * "setStackStyle" to select between more than just the "Mozilla" and
	 * "Rhino" formats.
	 * 
	 * @param flag
	...
	/**
	 * Specify the stack style to use from between three different formats:
	 * "Rhino" (the default), "Mozilla", and "V8." See StackStyle for
	 * information about each.
	 * 
	 * @param style
	 *            the style to select -- an instance of the StackStyle class
	 * @see StackStyle
	 * @since 1.8.0
	 */
	...
	/**
	 * Return the current stack style in use. Return the current stack style in
	 * use.
	 */
