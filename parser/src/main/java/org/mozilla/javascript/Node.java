...
public class Node implements Iterable<Node> {
	public static final int FUNCTION_PROP = 1, LOCAL_PROP = 2, LOCAL_BLOCK_PROP = 3, REGEXP_PROP = 4,
			...
			GENERATOR_END_PROP = 20, DESTRUCTURING_ARRAY_LENGTH = 21, DESTRUCTURING_NAMES = 22,
			DESTRUCTURING_PARAMS = 23, JSDOC_PROP = 24, EXPRESSION_CLOSURE_PROP = 25, // JS
																						// 1.8
																						// expression
																						// closure
																						// pseudo-return
			DESTRUCTURING_SHORTHAND = 26, // JS 1.8 destructuring shorthand
			ARROW_FUNCTION_PROP = 27, LAST_PROP = 27;
	 ...
	 * jsr instructions used to be. It is somewhat hackish, but implementing a
	 * clone() operation would take much, much more effort.
	 *
	...
	private static void toStringTreeHelper(ScriptNode treeTop, Node n, ObjToIntMap printIds, int level,
			StringBuilder sb) {
		if (Token.printTrees) {
			if (printIds == null) {
