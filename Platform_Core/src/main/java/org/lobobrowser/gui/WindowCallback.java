...
public interface WindowCallback {
     ...
     *            the response
     */
    void handleDocumentAccess(NavigatorFrame frame,
     ...
     *            the content
     */
    void handleDocumentRendering(NavigatorFrame frame,
     ...
     *            the exception
     */
    void handleError(NavigatorFrame frame, ClientletResponse response,
            Throwable exception);
