...
public class LazyMenuArrowImageIcon implements Icon {
    ...
    /** Gets the left to right icon.
	 *
	 * @return the left to right icon
	 */
    ...
    /** Gets the right to left icon.
	 *
	 * @return the right to left icon
	 */
