...
public class NavigatorWindowImpl implements NavigatorWindow, WindowCallback {
    ...
    public NavigatorWindowImpl(NavigatorFrame openerFrame, String windowId,
        ...
        if (window != null) {
            ...
            progressWindow.pack();
            // Then resize
            progressWindow.setSize(new Dimension(400, progressWindow
                    .getHeight()));
     ...
     * (non-Javadoc)
     * @see
     * org.lobobrowser.gui.WindowCallback#handleError(org.lobobrowser.ua.NavigatorFrame
     * , org.lobobrowser.clientlet.ClientletResponse, java.lang.Throwable)
     */
    @Override
     ...
     * (non-Javadoc)
     * @see
     * org.lobobrowser.gui.WindowCallback#handleDocumentAccess(org.lobobrowser.ua
     ...
     * (non-Javadoc)
     * @see
     * org.lobobrowser.gui.WindowCallback#handleDocumentRendering(org.lobobrowser
    ...
    /*
     * (non-Javadoc)
     * @see org.lobobrowser.gui.WindowCallback#updateProgress(org.lobobrowser.ua.
     ...
     * (non-Javadoc)
     * @see
     * org.lobobrowser.gui.WindowCallback#setStatus(org.lobobrowser.ua.NavigatorFrame
     * , java.lang.String)
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see org.lobobrowser.gui.WindowCallback#setDefaultStatus(org.lobobrowser.ua.
     ...
     * (non-Javadoc)
     * @see
     * org.lobobrowser.ua.NavigatorWindow#addAddressBarComponent(java.awt.Component)
     */
    @Override
     ...
     * (non-Javadoc)
     * @see
     * org.lobobrowser.ua.NavigatorWindow#addSharedToolBarComponent(java.awt.Component
     * )
     */
    @Override
     ...
     * (non-Javadoc)
     * @see
     * org.lobobrowser.ua.NavigatorWindow#addStatusBarComponent(java.awt.Component)
     */
    @Override
     ...
     * (non-Javadoc)
     * @see
     * org.lobobrowser.ua.NavigatorWindow#addNavigatorWindowListener(org.lobobrowser
     * .ua.NavigatorWindowListener)
     */
    @Override
     ...
     * (non-Javadoc)
     * @see
     * org.lobobrowser.ua.NavigatorWindow#removeNavigatorWindowListener(org.lobobrowser
     * .ua.NavigatorWindowListener)
     */
    @Override
     ...
     * (non-Javadoc)
     * @see
     * org.lobobrowser.ua.NavigatorWindow#createGlueComponent(java.awt.Component,
     * boolean)
     */
    @Override
     ...
     * (non-Javadoc)
     * @see
     * org.lobobrowser.ua.NavigatorWindow#goTo(org.lobobrowser.ua.NavigationEntry)
     */
    @Override
