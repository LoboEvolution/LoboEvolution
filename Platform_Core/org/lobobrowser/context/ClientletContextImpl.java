...
public class ClientletContextImpl implements ClientletContext {
     ...
     * (non-Javadoc)
     * @see
     * org.lobobrowser.clientlet.ClientletContext#getManagedStore(java.lang.String)
     */
    @Override
    ...
    public void navigate(String url) throws MalformedURLException {
        ...
        URL newURL = org.lobobrowser.util.Urls.guessURL(responseURL, url);
     ...
     * (non-Javadoc)
     * @see
     * org.lobobrowser.clientlet.ClientletContext#setResultingContent(java.awt.Component
     * )
     */
    @Override
     ...
     * (non-Javadoc)
     * @see
     * org.lobobrowser.clientlet.ClientletContext#setResultingContent(org.lobobrowser
     * .clientlet.ComponentContent)
     */
    @Override
     ...
     * (non-Javadoc)
     * @see
     * org.lobobrowser.clientlet.ClientletContext#setProgressEvent(org.lobobrowser
     * .ua.ProgressType, int, int)
     */
    @Override
     ...
     * @see
     * org.lobobrowser.clientlet.ClientletContext#setProgressEvent(org.lobobrowser
     * .ua.ProgressType, int, int, java.net.URL)
     */
    @Override
    public void setProgressEvent(ProgressType progressType, int value, int max,
            URL url) {
