...
public class HtmlController {
    ...
    public boolean onMouseClick(ModelNode node, MouseEvent event,
            RBlockViewport bodyLayout, int x, int y) {
        ...
        if (node instanceof HTMLDocumentImpl) {
            ...
            if (f != null && bodyLayout == null) {
                ...
                result = bodyLayout.onMouseClick(event, x - bodyLayout.x, y
                        - bodyLayout.y);
    ...
    public boolean onContextMenu(ModelNode node, MouseEvent event, int x, int y) {
        ...
        if (node instanceof HTMLAbstractUIElement) {
            ...
            if (f != null) {
                MouseEventImpl jsEvent = new MouseEventImpl("contextmenu",
                        uiElement, event, x, y);
                if (!Executor.executeFunction(uiElement, f, jsEvent)) {
                    return false;
                }
    ...
    public void onMouseOver(ModelNode node, MouseEvent event, int x, int y,
        ...
        while (node != null) {
            ...
            if (node instanceof HTMLDocumentImpl) {
                ...
                if (f != null) {
                    MouseEventImpl jsEvent = new MouseEventImpl("mouseover",
                            uiElement, event, x, y);
    ...
    public void onMouseOut(ModelNode node, MouseEvent event, int x, int y,
        ...
        while (node != null) {
            ...
            if (node instanceof HTMLAbstractUIElement) {
                ...
                if (f != null) {
                    MouseEventImpl jsEvent = new MouseEventImpl("mouseout",
                            uiElement, event, x, y);
                    Executor.executeFunction(uiElement, f, jsEvent);
                }
                HtmlRendererContext rcontext = uiElement
    ...
    public boolean onDoubleClick(ModelNode node, MouseEvent event,
        ...
        if (node instanceof HTMLDocumentImpl) {
            ...
            if (f != null && bodyLayout == null) {
                ...
                boolean result = Executor.executeFunction(uiDoc, f, null);
                result = bodyLayout.onDoubleClick(event, x - bodyLayout.x, y
                        - bodyLayout.y);
            ...
            if (f != null) {
                MouseEventImpl jsEvent = new MouseEventImpl("dblclick",
                        uiElement, event, x, y);
                if (!Executor.executeFunction(uiElement, f, jsEvent)) {
                    return false;
                }
     ...
     * @return True to propagate further, false if consumed.
     */
    public boolean onMouseDown(ModelNode node, MouseEvent event, RBlock block,
            int x, int y) {
        boolean pass = true;
        ...
        if (node instanceof HTMLDocumentImpl) {
            ...
            if (f != null) {
                MouseEventImpl jsEvent = new MouseEventImpl("mousedown",
                        uiElement, event, x, y);
     ...
     * @return True to propagate further, false if consumed.
     */
    public boolean onMouseUp(ModelNode node, MouseEvent event, RBlock block,
            int x, int y) {
        boolean pass = true;
        ...
        if (node instanceof HTMLDocumentImpl) {
            ...
            if (f != null) {
                MouseEventImpl jsEvent = new MouseEventImpl("mouseup",
                        uiElement, event, x, y);
                pass = Executor.executeFunction(uiElement, f, jsEvent);
            }
        }
    ...
    public boolean onKeyPress(ModelNode node, KeyEvent event) {
        ...
        if (node instanceof HTMLDocumentImpl) {
            ...
            if (f != null) {
                KeyboardEventImpl jsEvent = new KeyboardEventImpl("keypress",
                        uiElement, event);
                if (!Executor.executeFunction(uiElement, f, jsEvent)) {
                    return false;
                }
    ...
    public boolean onKeyUp(ModelNode node, KeyEvent event) {
        ...
        if (node instanceof HTMLDocumentImpl) {
            ...
            if (f != null) {
                KeyboardEventImpl jsEvent = new KeyboardEventImpl("keyup",
                        uiElement, event);
                if (!Executor.executeFunction(uiElement, f, jsEvent)) {
                    return false;
                }
