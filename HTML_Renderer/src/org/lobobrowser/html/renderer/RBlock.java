...
public class RBlock extends BaseElementRenderable implements
	...
	// /**
	// * Adjustment step which must be done after layout. This will expand
	// blocks
	...
	// blockFloatBounds, this.defaultOverflowX, this.defaultOverflowY,
	// whiteSpace, font, expandWidth, expandHeight, useDeclaredSize);
	...
	// }
	// else {
	// tentativeHeight = declaredHeight + paddingInsets.top +
