 ...
 * (non-Javadoc)
 * @see
 * org.lobobrowser.html.renderer.BoundableRenderable#onMouseClick(java.awt.event
 * .MouseEvent, int, int)
 */
    @Override
    public boolean onMouseClick(MouseEvent event, int x, int y) {
        ...
        if (me != null) {
            return HtmlController.getInstance().onMouseClick(me, event, null,
                    x, y);
        } else {
            return true;
        }
 ...
 */
    ...
    public boolean onDoubleClick(MouseEvent event, int x, int y) {
        ModelNode me = this.modelNode;
        if (me != null) {
            return HtmlController.getInstance().onDoubleClick(me, event, null,
                    x, y);
        } else {
            return true;
        }
 ...
 */
    ...
    public boolean onMousePressed(MouseEvent event, int x, int y) {
        ModelNode me = this.modelNode;
        if (me != null) {
            return HtmlController.getInstance().onMouseDown(me, event, null, x,
                    y);
        } else {
            return true;
        }
 ...
 * (non-Javadoc)
 * @see
 * org.lobobrowser.html.renderer.BoundableRenderable#onMouseReleased(java.awt
 * .event.MouseEvent, int, int)
 */
    @Override
 ...
 * (non-Javadoc)
 * @see
 * org.lobobrowser.html.renderer.BoundableRenderable#onMouseDisarmed(java.awt
 * .event.MouseEvent)
 */
    @Override
    ...
    public boolean onKeyPressed(KeyEvent event) {
        ...
        if (me != null) {
            ...
            return HtmlController.getInstance().onKeyPress(this.modelNode,
                    event);
    ...
    public boolean onKeyDown(KeyEvent event) {
        ...
        if (me != null) {
            ...
            return HtmlController.getInstance()
                    .onKeyDown(this.modelNode, event);
 ...
 * (non-Javadoc)
 * @see
 * org.lobobrowser.html.renderer.BaseBoundableRenderable#getBlockBackgroundColor
 * ()
 */
    @Override
    ...
    /*
 * (non-Javadoc)
 * @see org.lobobrowser.html.render.BoundableRenderable#paintSelection(java.awt.
