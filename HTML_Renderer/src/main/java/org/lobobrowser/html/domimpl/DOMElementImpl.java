...
public class DOMElementImpl extends DOMNodeImpl implements Element {
     ...
     * (non-Javadoc)
     * @see
     * org.lobobrowser.html.domimpl.DOMNodeImpl#equalAttributes(org.w3c.dom.Node)
     */
    @Override
    ...
    public boolean getHidden() {
        return this.getAttribute(HtmlAttributeProperties.HIDDEN) == null ? true
                : false;
    }
    ...
    public void setContentEditable(String contenteditable) {
        this.setAttribute(HtmlAttributeProperties.CONTENTEDITABLE,
                contenteditable);
    }
    ...
    public void setDraggable(boolean draggable) {
        this.setAttribute(HtmlAttributeProperties.DRAGGABLE,
                String.valueOf(draggable));
    }
    ...
    public boolean getDisabled() {
        return this.getAttribute(HtmlAttributeProperties.DISABLE) == null ? true
                : false;
    }
    ...
    public boolean getChecked() {
        return this.getAttribute(HtmlAttributeProperties.CHECKED) == null ? true
                : false;
    }
    ...
    public void setItemScope(boolean itemscope) {
        this.setAttribute(HtmlAttributeProperties.ITEMSCOPE,
                String.valueOf(itemscope));
     ...
     * (non-Javadoc)
     * @see
     * org.lobobrowser.html.domimpl.DOMNodeImpl#htmlEncodeChildText(java.lang.String
     * )
     */
    @Override
