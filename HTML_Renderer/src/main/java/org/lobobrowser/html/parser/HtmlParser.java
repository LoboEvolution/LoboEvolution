...
public class HtmlParser {
    ...
    /** The entities. */
    private static Map<String, Character> ENTITIES = new HashMap<String, Character>(
            256);

    /** The element infos. */
    private static Map<String, ElementInfo> ELEMENT_INFOS = new HashMap<String, ElementInfo>(
            35);
    ...
    SAXException {
        ...
        try {
            ...
            try {
                while (this.parseToken(parent, reader, null,
                        new LinkedList<String>()) != TOKEN_EOD) {
                    ;
                }
    ...
    private final int parseToken(Node parent, LineNumberReader reader,
            Set<String> stopTags, LinkedList<String> ancestors)
    ...
    /*
     * private final Locator getLocator(int lineNumber, int columnNumber) {return
     * new LocatorImpl(this.publicId, this.systemId, lineNumber, columnNumber);}
     */
