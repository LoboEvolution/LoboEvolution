/*
 * GNU LESSER GENERAL PUBLIC LICENSE Copyright (C) 2014 Uproot Labs India Pvt
 * Ltd This library is free software; you can redistribute it and/or modify it
...
public class RInlineBlock extends BaseElementRenderable {
    ...
    public RInlineBlock(final RenderableContainer container,
        ...
        final RBlock child = new RBlock(modelNode, 0, userAgentContext,
                rendererContext, frameContext, this);
 ...
 * (non-Javadoc)
 * @see
 * org.lobobrowser.html.dombl.UINode#repaint(org.lobobrowser.html.dombl.ModelNode
 * )
 */
    @Override
 ...
 */
    @Override
    protected void doLayout(final int availWidth, final int availHeight,
            final boolean sizeOnly) {
        this.child
                .layout(availWidth, availHeight, false, false, null, sizeOnly);
        assignDimension();
    }
