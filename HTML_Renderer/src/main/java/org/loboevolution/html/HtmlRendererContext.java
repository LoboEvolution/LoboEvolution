...
public interface HtmlRendererContext {
	 ...
	 *            The encoding type.
	 * @param formInputs
	 *            An array of {@link org.loboevolution.html.FormInput} instances.
	 */
	void submitForm(String method, URL action, String target, String enctype, FormInput[] formInputs);

	/**
	 * Creates a {@link org.loboevolution.html.BrowserFrame} instance.
	 *
	 ...
	 * @param replace
	 *            the replace
	 * @return A new {@link org.loboevolution.html.HtmlRendererContext} instance.
	 */
