...
public class HtmlMappingChar {
	...
	public static Map<String, Character> mappingChar() {
		...
		entities.put(HtmlCharProperties.EPSILON2, new Character((char) EPSILON2));
		...
		entities.put(HtmlCharProperties.OMICRON2, new Character((char) OMICRON2));
		...
		entities.put(HtmlCharProperties.UPSILON2, new Character((char) UPSILON2));
		...
		entities.put(HtmlCharProperties.THETASYM, new Character((char) THETASYM));
