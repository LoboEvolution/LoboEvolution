...
public class XPathFunctionResolverImpl implements XPathFunctionResolver, NamespaceContext {
	 ...
	 *            the function
	 */
	public static void installFunction(final AbstractFunction function) {
	 ...
	 *            the namespace
	 */
	public void addNamespaceMapping(final String namespacePrefix, final String namespace) {
	 ...
	 *            the namespace prefix
	 */
	public void removeNamespaceMapping(final String namespacePrefix) {
	...
	private static class Signature {
		 ...
		 *            the arity
		 */
		public Signature(final QName functionName, final int arity) {
