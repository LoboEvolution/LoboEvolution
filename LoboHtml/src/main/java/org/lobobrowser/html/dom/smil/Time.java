...
public interface Time {
	 ...
	 * current <code>Time</code> must be defined (not indefinite), the syncbase
	 * and all <code>Time</code> 's that the syncbase depends on must be defined
	 * (not indefinite), and the begin <code>Time</code> of all ascendent time
	 * containers of this element and all <code>Time</code> elements that this
	 * depends upon must be defined (not indefinite). <br>
	 * If this <code>Time</code> is based upon an event, this <code>Time</code>
