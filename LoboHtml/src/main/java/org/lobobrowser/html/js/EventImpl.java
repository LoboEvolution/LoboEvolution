...
public class EventImpl extends AbstractScriptableDelegate implements Event {
	...
	public EventImpl(final String type, final Node srcElement, final java.awt.event.InputEvent mouseEvent, final int leafX,
			final int leafY) {
		this.type = type;
		this.srcElement = srcElement;
		this.leafX = leafX;
	...
	public EventImpl(final String type, final Node srcElement, final java.awt.event.KeyEvent keyEvent) {
		this.type = type;
		this.srcElement = srcElement;
	...
	public EventImpl(final String type, final Node srcElement) {
		this.type = type;
		this.srcElement = srcElement;
		this.inputEvent = null;
		this.bubbles = true;
	...
	public EventTarget getTarget() {
		...
		// TODO: Target and source may not be always same. Need to add a constructor
		// param for target.
