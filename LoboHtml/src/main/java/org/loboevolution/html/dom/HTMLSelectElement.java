...
public interface HTMLSelectElement extends HTMLElement {
	/**
	 * Add a new element to the collection of <code>OPTION</code> elements for this
	 * <code>SELECT</code>. This method is the equivalent of the
	 * <code>appendChild</code> method of the <code>Node</code> interface if the
	 * <code>before</code> parameter is <code>null</code>. It is equivalent to the
	 * <code>insertBefore</code> method on the parent of <code>before</code> in all
	 * other cases. This method may have no effect if the new element is not an
	 * <code>OPTION</code> or an <code>OPTGROUP</code>.
	 * 
	 * @param element The element to add.
	 * @param before  The element to insert before, or <code>null</code> for the
	 *                tail of the list.
	 * @exception DOMException NOT_FOUND_ERR: Raised if <code>before</code> is not a
	 ...
	 * multiple attribute is <code>true</code> and the string "select-one" when
	 * <code>false</code>.
	 */
	String getType();
