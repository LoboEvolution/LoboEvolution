...
public class CSS3Parser extends AbstractCSSParser implements CSS3ParserConstants {
    ...
    public String getParserVersion() {
        return "https://www.w3.org/Style/CSS/";
    }

    protected String getGrammarUri()
    {
        return "https://www.w3.org/TR/css-syntax-3/";
    }
...
//  ;
//
  final public Combinator combinator() throws ParseException {Combinator c = Combinator.DESCENDANT_COMBINATOR;
    switch (jj_ntk == -1 ? jj_ntk_f() : jj_ntk) {
    case PLUS:{
      jj_consume_token(PLUS);
c = Combinator.NEXT_SIBLING_COMBINATOR;
      label_36:
      while (true) {
        switch (jj_ntk == -1 ? jj_ntk_f() : jj_ntk) {
        case S:{
...
c = Combinator.SUBSEQUENT_SIBLING_COMBINATOR;
      label_38:
      while (true) {
        switch (jj_ntk == -1 ? jj_ntk_f() : jj_ntk) {
        case S:{
...
return c;
  ...
  final public Combinator relativeCombinator() throws ParseException {Combinator c = Combinator.DESCENDANT_COMBINATOR;
    switch (jj_ntk == -1 ? jj_ntk_f() : jj_ntk) {
    case PLUS:
    case GREATER:
    case TILDE:{
...
selList.add(sel);
  ...
  final public SelectorList relativeSelectorList() throws ParseException {SelectorListImpl selList = new SelectorListImpl();
    Selector sel;
    Combinator comb;
...
//  ;
//
  final public Selector simpleSelector(Selector sel, Combinator comb) throws ParseException {ElementSelector elemSel = null;
...
if (pseudoElementFound) { throw toCSSParseException("duplicatePseudo", new String[] { function + selectorList + ")" }, locator); }
      ...
      case FUNCTION_IS:{
        t = jj_consume_token(FUNCTION_IS);
function = unescape(t.image, false);
        label_59:
        while (true) {
          switch (jj_ntk == -1 ? jj_ntk_f() : jj_ntk) {
...
if (pseudoElementFound) { throw toCSSParseException("duplicatePseudo", new String[] { function + selectorList + ")" }, locator); }
      ...
      case FUNCTION_WHERE:{
        t = jj_consume_token(FUNCTION_WHERE);
function = unescape(t.image, false);
        label_60:
        while (true) {
          switch (jj_ntk == -1 ? jj_ntk_f() : jj_ntk) {
...
if (pseudoElementFound) { throw toCSSParseException("duplicatePseudo", new String[] { function + selectorList + ")" }, locator); }
      ...
      case FUNCTION_HAS:{
        t = jj_consume_token(FUNCTION_HAS);
function = unescape(t.image, false);
        label_61:
        while (true) {
          switch (jj_ntk == -1 ? jj_ntk_f() : jj_ntk) {
...
value = LexicalUnitImpl.createVMax(prev, doubleValue(op, t.image));
    ...
    case DVW:{
      t = jj_consume_token(DVW);
value = LexicalUnitImpl.createDvw(prev, doubleValue(op, t.image));
      break;
      }
    case DVH:{
      t = jj_consume_token(DVH);
value = LexicalUnitImpl.createDvh(prev, doubleValue(op, t.image));
      break;
      }
    case DVMIN:{
      t = jj_consume_token(DVMIN);
value = LexicalUnitImpl.createDvMin(prev, doubleValue(op, t.image));
      break;
      }
    case DVMAX:{
      t = jj_consume_token(DVMAX);
value = LexicalUnitImpl.createDvMax(prev, doubleValue(op, t.image));
      break;
      }
    case LVW:{
      t = jj_consume_token(LVW);
value = LexicalUnitImpl.createLvw(prev, doubleValue(op, t.image));
      break;
      }
    case LVH:{
      t = jj_consume_token(LVH);
value = LexicalUnitImpl.createLvh(prev, doubleValue(op, t.image));
      break;
      }
    case LVMIN:{
      t = jj_consume_token(LVMIN);
value = LexicalUnitImpl.createLvMin(prev, doubleValue(op, t.image));
      break;
      }
    case LVMAX:{
      t = jj_consume_token(LVMAX);
value = LexicalUnitImpl.createLvMax(prev, doubleValue(op, t.image));
      break;
      }
    case SVW:{
      t = jj_consume_token(SVW);
value = LexicalUnitImpl.createSvw(prev, doubleValue(op, t.image));
      break;
      }
    case SVH:{
      t = jj_consume_token(SVH);
value = LexicalUnitImpl.createSvh(prev, doubleValue(op, t.image));
      break;
      }
    case SVMIN:{
      t = jj_consume_token(SVMIN);
value = LexicalUnitImpl.createSvMin(prev, doubleValue(op, t.image));
      break;
      }
    case SVMAX:{
      t = jj_consume_token(SVMAX);
value = LexicalUnitImpl.createSvMax(prev, doubleValue(op, t.image));
      break;
      }
    case ANGLE_DEG:{
...
return hexColorInternal(prev, t);
 ...
 {
    if (jj_scan_token(DVW)) return true;
    return false;
  }

  private boolean jj_3R_253()
 {
    if (jj_scan_token(DVH)) return true;
    return false;
  }

  private boolean jj_3R_254()
 {
    if (jj_scan_token(DVMIN)) return true;
    return false;
  }

  private boolean jj_3R_255()
 {
    if (jj_scan_token(DVMAX)) return true;
    return false;
  }
 ...
 {
    if (jj_scan_token(LVW)) return true;
    return false;
  }
 ...
 {
    if (jj_scan_token(LVH)) return true;
    return false;
  }
 ...
 {
    if (jj_scan_token(LVMIN)) return true;
    return false;
  }

  private boolean jj_3R_259()
 {
    if (jj_scan_token(LVMAX)) return true;
    return false;
  }

  private boolean jj_3R_260()
 {
    if (jj_scan_token(SVW)) return true;
    return false;
  }

  private boolean jj_3R_261()
 {
    if (jj_scan_token(SVH)) return true;
    return false;
  }

  private boolean jj_3R_262()
 {
    if (jj_scan_token(SVMIN)) return true;
    return false;
  }
 ...
 {
    if (jj_scan_token(SVMAX)) return true;
    return false;
  }
  ...
  private boolean jj_3R_315()
 {
  ...
  static {
	...
	private static void jj_la1_init_0() {
	   jj_la1_0 = new int[] {0x30000002,0x30000002,0x30000002,0x30000002,0x0,0xf50000,0xf50000,0xf50000,0x30000002,0x30000002,0x2,0xf50000,0x2,0x2,0x4000000,0x2,0xf60000,0x2,0x2,0xf50000,0x0,0x2,0x60000,0x2,0x60000,0x10000,0x2,0x10000,0x2,0xf60000,0x2,0x2,0x2,0xf00000,0x2,0x0,0x2,0xf50000,0x2,0xf50000,0x2,0x2,0xf50000,0x2,0x0,0x2,0xf50000,0x0,0x2,0x2,0x2,0x2,0x2,0x0,0x2,0x2,0x2,0x0,0x2,0x0,0x2,0x2,0x2,0x2,0x0,0x0,0x0,0x2,0x1,0x2,0x0,0x2,0x0,0x2,0x2,0x0,0x0,0x0,0x0,0xf50000,0xf50000,0x2,0x2,0xc0000000,0x2,0x4f50000,0x2,0x2,0xf50000,0xc0000000,0x0,0x2,0x2,0x2,0x2,0x2,0x2,0x2,0x4fd0000,0x2,0x4fd0000,0xf50000,0xf50000,0x0,0x2,0xf50000,0x0,0x2,0x2,0x2,0x2,0x4fc0000,0xf50000,0x0,0x0,0x2,0x4fc0000,0x0,0x0,0x80000,0x0,0x4fc0000,0x2,0x2,0x4fc0000,0x0,0x2,0x0,0x4fc0000,0x2,0x0,0x0,0x2,0x0,0x2,0x2,0x0,0x0,0xfd0000,0x0,0xfd0000,0x2,0x0,0x0,0x2,0x0,0x2,0x2,0x0,0x0,0xfd0000,0x0,0xfd0000,0x2,0x2,0x2,0x0,0x2,0x0,0x4fc0000,0x2,0x2,0xf50000,0x2,0x0,0xfd0000,0x2,0x0,0xfd0000,0x2,0x0,0xfd0000,0x2,0x2,0x0,0x0,0xfd0000,0x2,0xfd0000,0x0,0x280000,0x2,0x2,0x0,0x0,0x280000,0x2,0x2,0x0,0x0,0x280000,0x2,0x0,0x2,0x0,0x0,0x280000,0x2,0x280000,0x680000,0x2,0x2,0xf50000,0x2,0x0,0xfd0000,0x2