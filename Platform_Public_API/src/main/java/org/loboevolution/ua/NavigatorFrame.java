...
public interface NavigatorFrame {
	 ...
	 * @param component
	 *            the component
	 * @see org.loboevolution.clientlet.ClientletContext#setResultingContent(Component)
	 */
	void replaceContent(ClientletResponse response, ComponentContent component);

	/**
	 * A simple alternative to
	 * {@link #replaceContent(org.loboevolution.clientlet.ClientletResponse, org.loboevolution.clientlet.ComponentContent)}
