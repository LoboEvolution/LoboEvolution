...
public interface ClientletContext {
	 ...
	 */
	org.lobobrowser.clientlet.ContentBuffer createContentBuffer(String contentType, byte[] content);
	 ...
	 */
	org.lobobrowser.clientlet.ContentBuffer createContentBuffer(String contentType, String content, String encoding)
			throws UnsupportedEncodingException;
	 ...
	 */
	void setProgressEvent(org.lobobrowser.ua.ProgressType progressType, int value, int max);
	 ...
	 * @see NavigatorFrame#setProgressEvent(NavigatorProgressEvent)
	 */
	void setProgressEvent(org.lobobrowser.ua.ProgressType progressType, int value, int max, URL url);
