...
public final class Axis {
   ...
   * consist of the parent of context node and the parent's parent and so on; thus, the ancestor
   ...
   * the context node in document order, excluding any ancestors and excluding attribute nodes and
   * namespace nodes
   */
